package
{
	...
	public class PlayState extends FlxState
	{
		...
		protected function generateLevel():void
		{
			...
			b = new FlxTileblock(0, 0, 640, 32);
			/*
			b.loadTiles(ImgBrick);
			_blocks.add(b);
			
			b = new FlxTileblock(0,32,32,640-32);
			b.loadTiles(ImgBrick);
			_blocks.add(b);
			
			b = new FlxTileblock(640-32,32,32,640-32);
			b.loadTiles(ImgBrick);
			_blocks.add(b);
			
			b = new FlxTileblock(32,640-32,640-32,32);
			b.loadTiles(ImgBrick);
			_blocks.add(b);
			*/
